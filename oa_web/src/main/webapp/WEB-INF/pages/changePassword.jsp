                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="new1" class="field prepend-icon">
                                    <input type="password" name="password" id="new1" class="gui-input" placeholder="重复密码...">
                            ...
                            <div class="col-md-6">
                                <label for="new2" class="field prepend-icon">
                                    <input type="password" name="rePassword" id="new2" class="gui-input" placeholder="重复密码...">
